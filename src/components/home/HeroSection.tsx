...
function HeroSection({}) {
  ...
  return (
    <div className="relative flex flex-col min-h-screen items-center justify-center bg-[#030308] overflow-hidden">
      <SpaceParticles />
      ...
      <div className="relative z-10 flex flex-col items-center px-6 text-center">
        ...
        >
          <h1
            className={`max-w-5xl text-9xl font-black leading-[1.08] tracking-tight text-[#f5f5f5] transition-all duration-700 delay-150 sm:text-6xl md:text-7xl ${
          ...
          >
            Knovel is a social publishing platform where writers publish,
            readers discover, and communities grow around stories.
          </p>
      ...
      {/* Scroll indicator */}
      <div
        className={`absolute bottom-10 left-1/2 flex -translate-x-1/2 flex-col items-center gap-2 transition-all duration-700 delay-[700ms] ${
