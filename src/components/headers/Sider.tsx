    ...
    <div className="w-full h-full flex flex-col text-white mx-4 my-4 items-center">
      ...
      <div className="w-full flex flex-col items-center justify-center my-6 rounded-xl text-sm">
        <div
          ...
          className="group relative flex w-full py-2 px-2 space-x-2 items-center justify-center rounded-xl hover:cursor-pointer hover:bg-[#7F60F9]/10 hover:backdrop-blur-lg hover:border hover:border-[#7F60F9]/15 hover:font-black"
        >
          <HomeIcon className="size-8" />
          <span
            className="pointer-events-none hidden group-hover:inline-block absolute left-full ml-3 top-1/2 -translate-y-1/2 whitespace-nowrap 
          rounded-md px-2 py-1 text-xs bg-black/80 text-white shadow-lg z-50"
          >
            Home
          </span>
        ...
        <div
          ...
          className="group relative flex w-full py-2 px-2 space-x-2 items-center justify-center hover:cursor-pointer hover:bg-[#7F60F9]/10 hover:backdrop-blur-lg rounded-xl hover:border hover:border-[#7F60F9]/15 hover:font-black"
        >
          <Dashboard className="size-8" />
          <span
            className="pointer-events-none hidden group-hover:inline-block absolute left-full ml-3 top-1/2 -translate-y-1/2 whitespace-nowrap 
          rounded-md px-2 py-1 text-xs bg-black/80 text-white shadow-lg z-90"
          >
            Collection
          </span>
        </div>
        ...
        <div
          ...
          className="group relative flex w-full py-2 px-2 space-x-2 items-center justify-center hover:cursor-pointer hover:bg-[#7F60F9]/10 hover:backdrop-blur-lg rounded-xl hover:border hover:border-[#7F60F9]/15 hover:font-bold"
        >
      ...
      {showConnect && (
        <div
          ref={dropdownRef}
          className="fixed top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50 backdrop-blur-md flex justify-center items-center z-50 text-base"
        >
