    ...
    <div className="flex w-full justify-between items-center backdrop-blur-md px-4 py-2 z-30">
      <div className="relative items-center basis-2/4 lg:basis-3/4 md:basis-full md:w-full">
        <form
          ...
          className="flex items-center bg-[#7F60F9]/20 backdrop-blur-lg border border-[#7F60F9]/15 w-full rounded-3xl p-0.5"
        >
          <div className="w-full flex rounded-3xl items-center px-2">
            ...
            <button
              type="submit"
              className="py-2 text-black font-bold px-2 rounded-3xl border-l border-[#7c7a85]"
            >
      ...
      <div
        ref={dropdownRef}
        className="flex md:hidden border border-[#272831] rounded-xl px-2 items-center hover:cursor-pointer"
      >
        <ConnectButton
          client={client}
          chain={avalanchefuji}
