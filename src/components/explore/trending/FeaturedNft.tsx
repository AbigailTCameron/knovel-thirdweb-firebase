...
function FeaturedNft({setMintPopup}: Props) {
  return (
    <div className="flex w-full h-full justify-center px-20 items-center text-white py-4">
      <div className="flex flex-col w-1/2 space-y-4">
            ...
            <p className="text-xl font-light">We are thrilled to announce the launch of our exclusive “Early Access Golden Medallion” NFT—a special token of appreciation for our early adopters. 
            ...
            <p className="text-xl font-light"> Seize this opportunity to own a piece of our journey.</p>

            <div onClick={()=> setMintPopup(true)} className="w-1/3">
                <FlowButton 
                  title='Claim now!'
                  buttonWidth='w-full'
