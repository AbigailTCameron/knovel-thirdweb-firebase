  ...
  return (
    <div className="flex flex-col space-y-4 py-4 w-full text-sm font-medium text-[#e3e4e5]">
      ...
      <div
        ...
        className="flex items-center space-x-2 hover:cursor-pointer hover:bg-black px-3 py-3"
      >
        <HomeIcon />
        <p>dashboard</p>
      </div>
      ...
      <div
        ...
        className="hidden halflg:flex items-center space-x-2 hover:cursor-pointer hover:bg-black px-3 py-3"
      >
        <WorldIcon />
        <p>community</p>
      </div>
