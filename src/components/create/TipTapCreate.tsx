...
function TipTapCreate({userId, name, setLoading, username}: Props) {
  ...
  return (
    <main className="flex md:flex-col w-full h-full items-center space-x-2 p-4 font-mono"> 
        <div className="relative flex flex-col w-full h-full basis-1/4 bg-[#7F60F9]/5 backdrop-blur-lg border border-[#7F60F9]/15 rounded-2xl text-white">
            ...
            <div className="flex flex-col md:flex-row md:w-full ss:hidden">
                ...
                <div className="flex w-full space-x-1 px-2 md:px-1 mt-2 md:mt-0 md:text-base sm:text-sm">
                  ...
                  <Strikethrough
                    className={`${editor?.isActive('strike') ? 'hover:cursor-pointer w-1/4 md:size-10 sm:size-8 p-2 size-14 bg-white rounded-md stroke-slate-500' : 'hover:cursor-pointer w-1/4 p-2 size-14 md:size-10 sm:size-8 bg-[#7F60F9]/5 backdrop-blur-lg rounded-md stroke-slate-500'}`}
        ...
        <div className="flex flex-col space-y-1 w-full h-full basis-3/4  rounded-2xl text-white">
            <div className="flex basis-1/12 w-full h-full rounded-2xl bg-[#7F60F9]/5 backdrop-blur-lg border border-[#7F60F9]/15">
