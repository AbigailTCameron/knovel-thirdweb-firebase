...
function ImageUploader({setImageFile, setFilename}: Props) {
    ...
    <div className="w-[250px] md:h-fit h-[375px] flex flex-col my-4 self-center">
        ...
        >
          ...
          {imageSrc ? (
            ...
            <div
              className={`flex bg-[#2a2929] text-center items-center justify-center rounded-xl w-full h-full ${isHovered && "opacity-50"}`}>
                ...
                <div className="flex flex-col w-1/3 h-3/4 bg-black/60 text-white rounded-xl shadow-lg p-6">
                    <div className="relative w-full h-full">    
                        <Cropper 
                          ...
                          crop={crop}
                          zoom={zoom}
                          aspect={1/1.6} // 1:1.6 aspect ratio
