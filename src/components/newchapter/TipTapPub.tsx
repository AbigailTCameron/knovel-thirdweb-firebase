...
function TipTapPub({ id, userId}: Props) {
  ...
  const handleSubmit = async() => { 
    ...
    await handleUpdateAnotherPublishChapter(id, titleContent, content, setError, userId)
    router.push(`/editPublish/${userId}/${id}`); 
  }
